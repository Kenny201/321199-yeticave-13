...
VALUES (1, 1, DATE_ADD(NOW(), INTERVAL 1 DAY), '2014 Rossignol District Snowboard',
        'Супер сноуборд для самых лучших сноубордистов', 'img/lot-1.jpg', 10999, 11500, 500, NOW()),
       (2, 1, DATE_ADD(NOW(), INTERVAL 1 DAY), 'DC Ply  Mens 2016/2017 Snowboard',
        'Сноуборд такой крутой, что даже ездить жалко', 'img/lot-2.jpg', 159990, 160600, 600, NOW()),
       (3, 2, DATE_ADD(NOW(), INTERVAL 1 DAY), 'Крепления Union Contact Pro 2015 года размер L/XL',
        'Благодаря им вы станете чемпионом', 'img/lot-3.jpg', 8000, 8700, 700, NOW()),
       (4, 3, DATE_ADD(NOW(), INTERVAL 1 DAY), 'Ботинки для сноуборда DC Mutiny Charocal', 'Классные ботинки',
        'img/lot-4.jpg',
        10999, 11999, 900, NOW()),
       (4, 4, DATE_ADD(NOW(), INTERVAL 1 DAY), 'Куртка для сноуборда DC Mutiny Charocal',
        'Вы будете самый модный на склоне',
        'img/lot-5.jpg', 7500, 8400, 900, NOW()),
       (6, 4, DATE_ADD(NOW(), INTERVAL 1 DAY), 'Маска Oakley Canopy', 'Даже банк ограбить в такой не стыдно',
        'img/lot-6.jpg',
        5400, 6400, 1000, NOW());

# UPDATE lots
# SET completed_at = DATE_ADD(NOW(), INTERVAL 1 HOUR)
# WHERE id = 1;
#
# UPDATE lots
# SET start_price = 90
